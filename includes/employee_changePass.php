...
<div class="change-password-container">
  ...
  <a href="/Archube/Archcube_payroll/includes/empDash.php" class="btn btn-danger" style="background-color: #dc3545; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;">
  ⬅ Back to Dashboard
</a>
